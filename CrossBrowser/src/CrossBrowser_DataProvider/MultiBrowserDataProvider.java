package CrossBrowser_DataProvider;
...
public class MultiBrowserDataProvider {
	WebDriver driver;
	

	@Test(dataProvider="BrowserData")//dataprovider  d should be lowercase
	public void facebookSignUp(String browsername) throws Exception{
